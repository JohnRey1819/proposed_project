...
<head>
    ...
    <style>
        ...
        .app-card { max-width: 600px; box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15); border-radius: 1rem; }
        .nav-pills .nav-link { border-radius: 0.75rem; font-weight: 600; }
                    ...
                    <div class="p-4 rounded-3 border border-primary-subtle bg-primary-subtle">
                        <form onsubmit="event.preventDefault(); submitPresent();">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg rounded-3" id="signin-id" placeholder="e.g., 21-1-2414" required>
                            </div>
                    ...
                    <div class="p-4 rounded-3 border bg-light">
                        <form onsubmit="event.preventDefault(); submitRegister();">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-3" id="reg-id" **placeholder="e.g., 24-1-2414"** required>
                            </div>
                            <div class="mb-4">
                                <label for="reg-name" class="form-label fw-bold">Full Name</label>
                                <input type="text" class="form-control rounded-3" id="reg-name" **placeholder="e.g., Turalde John Rey M."** required>
                            </div>
